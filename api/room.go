...
func (self *RoomHandler) HandleListRooms(ctx *fiber.Ctx) error {
	rooms, err := self.roomStore.GetRooms(ctx.Context())
	if err != nil {
...
func (self *RoomHandler) HandleGetRoom(ctx *fiber.Ctx) error {
	...
	room, err := self.roomStore.GetRoomByID(ctx.Context(), id)
	if err != nil {
		return fiber.NewError(fiber.StatusBadRequest, err.Error())
	}
	if room == nil {
...
func (self *RoomHandler) HandleCreateRoom(ctx *fiber.Ctx) error {
	...
	createdRoom, err := self.roomStore.CreateRoom(ctx.Context(), room)
	if err != nil {
		return err
	}
...
func (self *RoomHandler) HandleUpdateRoom(ctx *fiber.Ctx) error {
	...
	updatedRoom, err := self.roomStore.UpdateRoomByID(ctx.Context(), id, data)
	if err != nil {
		return err
	}
	if updatedRoom == nil {
...
func (self *RoomHandler) HandleDeleteRoom(ctx *fiber.Ctx) error {
	...
	err = self.roomStore.DeleteRoomByID(ctx.Context(), id)
	if err != nil {
		return err
	}
